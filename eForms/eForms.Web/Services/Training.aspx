<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Training.aspx.cs" Inherits="eForms.Web.Services.Training" MasterPageFile="~/Common/Services.master"%>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="HeadingContentPlaceHolder" runat="server">
    <h2 id="ourServices">
        <span style="color: #666666;">Training &amp;</span> Support
    </h2>
</asp:Content>
