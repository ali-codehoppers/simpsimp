...
namespace eForms.Web.Utilities
{
    public class CyberSourceCS
    {
        ...
        {
            return AppSettings[WebConstants.Config.MERCHANT_ID];
        ...
        {
            return AppSettings[WebConstants.Config.PUBLIC_KEY];
        ...
        {
            return AppSettings[WebConstants.Config.PRIVATE_KEY];
        ...
        {
            return AppSettings[WebConstants.Config.SERIAL_NUMBER];
