<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Main.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="eForms.Web.Default" %>
        ...
        <div class="textDiv" style="padding-top: 15px;">
            <div>
                <p style="text-align: justify; font-size: 16px; font-weight: bold">
                    What's going to help deliver more profit across your entire business operation?
                </p>
            </div>
            <div style="border-top: 1px solid #d4efff;">
                <p style="text-align: justify; font-size: 14px">
                    Buy streamlining business processes for data entry, through day to day operations,
                    to invoicing and payments, Simplicity for Business are helping their clients keep
                    one step ahead of the competition.</p>
                <p style="text-align: justify; font-size: 14px">
                    Through the design, development and implementation of a suite of award-winning business
                    software applications, Simplicity for Business deliver real, measurable benefits
                    for their clients.
                </p>
                <p style="text-align: justify; font-size: 14px">
                    Challenge the way you manage your business by talking to one of our business managers
                    - talk to us today. <span style='color:white'>020 7272 8127</span>
                </p>
            </div>
            <%--			<div style="border-top:1px solid #d4efff; ">
