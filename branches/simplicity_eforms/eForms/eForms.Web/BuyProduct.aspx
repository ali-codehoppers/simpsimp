<%@ Page Title="" Language="C#" MasterPageFile="~/Common/LeftMenu.Master" AutoEventWireup="true"
    CodeBehind="BuyProduct.aspx.cs" Inherits="eForms.Web.BuyProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div>
        <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=SIMPLICITY_eFORMSEntities"
            DefaultContainerName="SIMPLICITY_eFORMSEntities" EnableFlattening="False" EntitySetName="Products">
