<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Main.master" AutoEventWireup="true"
    CodeBehind="Trolley.aspx.cs" Inherits="eForms.Web.Trolley" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <div id="contentMain" style="padding-left: 30px; padding-right: 30px;">
        ...
        <div class="trolleyActions" style="width: 100%; float: right; padding-top: 10px;
            padding-bottom: 10px;">
            <div class="trolleyFooterCol1" style="float: right">
                <span style="font-weight: bold; font-style: italic;">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <%= GetCurrencyHTMLCode()%><%= String.Format("{0:N2}", eForms.Web.BusinessObjects.ShoppingCart.GetTotalAmount())%>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </div>
        </div>
        <div class="floatRight">
