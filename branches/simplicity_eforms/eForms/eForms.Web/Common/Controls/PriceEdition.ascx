<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PriceEdition.ascx.cs" Inherits="eForms.Web.Common.Controls.PriceEdition" %>
                ...
                <asp:Repeater ID="rptVersions" runat="server">
                    <ItemTemplate>
                        <div class="colfooter" style="float: left; padding-top:35px;">
                            ...
                            <br />
                            <%if (Request[eForms.Web.Utilities.WebConstants.Request.PRODUCT_ID] == "2")
                              {%>
                            <span style="font-size: 10pt; color: Gray; padding-left:40px;">Try it now for</span> <a href="../../RedirectToProductTrial.aspx?productId=<%#Request[eForms.Web.Utilities.WebConstants.Request.PRODUCT_ID]%>" style="font-family:Lucida Sans;font-size: 12pt; color: #f29107">FREE</a>
                            <%}%>
                            </div>
                        </div>
                    </ItemTemplate>
