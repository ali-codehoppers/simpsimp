<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Products.master" AutoEventWireup="true" CodeBehind="HandyLECPrice.aspx.cs" Inherits="eForms.Web.Products.HandyLEC.HandyLECPrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftNavPlaceHolder" runat="server">
    <div class="leftNavBarLEC">
        <div>
            <a href="../../WatchDemo.aspx?product_id=5" id="watch_lec" class="watch-demo"></a>
        </div>
        <div>
