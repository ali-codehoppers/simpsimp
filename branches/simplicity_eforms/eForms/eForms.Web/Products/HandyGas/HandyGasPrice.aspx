<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Products.master" AutoEventWireup="true" CodeBehind="HandyGasPrice.aspx.cs" Inherits="eForms.Web.Products.HandyGas.HandyGasPrice" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="LeftNavPlaceHolder" runat="server">
    <div class="leftNavBarGas">
        <div>
            <a href="../../WatchDemo.aspx?product_id=3" id="watch_gas" class="watch-demo"></a>
        </div>
        <div>
