<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Products.master" AutoEventWireup="true"
    CodeBehind="Home.aspx.cs" Inherits="Simplicity.Web.Products.Online.Home" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="LeftNavPlaceHolder" runat="server">
    <div class="leftNavBarOline">
        <div>
            <a href="../../WatchDemo.aspx?product_id=1" id="watch_Online"></a>
        </div>
        <div>
            <a href="EASPrice.aspx?productid=1" id="buy_Online"></a>
        </div>
        <div>
            <a href="EASPrice.aspx?productid=1&try=try" id="try_Online"></a>
        </div>
        <div>
