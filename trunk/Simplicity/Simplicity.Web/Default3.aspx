...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <div id="contentTop" style="height:320px">
		...
		<div class="floatRight">
			...
			<div class="slideShow"><a href="Products/PS/Home.aspx"><img src="images/img_7.jpg" width="655" height="257" /></a>
	...
	<div id="contentMiddle">
        <div class="floatRight" style="width:165px; margin-right:50px; margin-top:50px;">
            <div id="manImage">
                <div style="padding-top:42px; text-align:center"><a href="CaseStudies.aspx"><img src="Images/btn_case_study2.jpg" /></a></div>
            </div>
		</div>
        <div class="textDiv">			  
            <div style="border-top:1px solid #d4efff; ">
				<p style="text-align:justify; font-size:15px">Simplicity  Online is part of the award winning Simplicity for Business software suite.  This web-based Software as a Service (SaaS) application suite automates  your business processes so you can reach optimum profit and business  performance. Now thanks to Simplicity Online you can move to an enterprise  application suite that requires nothing more than a web browser to use and is  available on a low-cost subscription. By taking information from first point of  contact through to final invoicing, Simplicity Online provides a seamless  way of managing enquiries, estimates, orders, variation orders, purchasing,  invoicing and payments and much much more. Information is entered once, giving  you full visibility of all of your business activity.</div>
		</div>
	</div>
