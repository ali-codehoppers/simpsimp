<%@ Page Title="" Language="C#" MasterPageFile="~/Common/HServeMain.master" AutoEventWireup="true" CodeBehind="HServeProduct.aspx.cs" Inherits="Simplicity.Web.Products.HServeProduct" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TextContentPlaceHolder" runat="server">
<h1>Products - Simplicity Handy Server -</h1> <h2>Want innovative mobile apps for your field operatives?</h2>
