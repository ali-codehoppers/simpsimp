<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ConfirmCheckout.aspx.cs" Inherits="Simplicity.Web.Admin.ConfirmCheckout" %>
...
<div id="PaymentAddresssubdirectory" class="PaymentAddressbottom_border">
    ...
    <div id="heading1">
        <h2>
            <span style="color: #666666;">CONFIRM</span> CHECKOUT</h2>
    </div>
    <div>
