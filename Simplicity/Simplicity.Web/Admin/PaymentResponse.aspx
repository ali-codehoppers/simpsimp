<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PaymentResponse.aspx.cs" Inherits="Simplicity.Web.Admin.PaymentResponse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
 <div style="margin-top: 25px;">
        ...
        <asp:Panel ID="panelSuccess" runat="server" Visible="false">
            ...
            <div>
                <asp:HyperLink ID="productsLogin" runat="server" NavigateUrl="http://www.google.com" />
            </div>
            <div>
                <div id="receipt" style="padding-left: 80px; padding-top: 20px; padding-bottom: 15px;">
                    <div class="col1">
                        Card holder's name:</div>
                    <div class="col2">
                        <% Response.Write(Request.Form.Get("billTo_firstName")); %>&nbsp;
                        <% Response.Write(Request.Form.Get("billTo_lastName")); %></div>
                    <div class="noFloat">
                    </div>
                    <div class="col1">
                        Card #:</div>
                    <div class="col2">
                        <% Response.Write(Request.Form.Get("card_accountNumber")); %></div>
                    <div class="noFloat">
                    </div>
                    <div class="col1">
                        Card Expiry:</div>
                    <div class="col2">
                        <% Response.Write(Request.Form.Get("card_expirationMonth")); %>/<% Response.Write(Request.Form.Get("card_expirationYear")); %></div>
                    <div class="noFloat">
                    </div>
                    <div class="col1">
                        Card Type:</div>
                    <div class="col2">
                        <% if (Request.Form.Get("card_cardType") == "001")
                           {%>Visa<% }
                    ...
                    <div style="padding-left: 200px; padding-top: 10px;">
                        <a href="JavaScript:window.print();">
                            <div class="receiptnavbar" style="width: 105px;">
                                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/btn_print.jpg"/></div>
                        </a>
                    </div>
            </div>
    </div>
    ...
    <asp:Panel ID="panelFailure" runat="server" Visible="false">
        <div>
            <div style="color: Red; font-weight: bold; font-size: 13px;">
                Some error occured while processing the payment</div>
            <div style="padding-top: 5px; color: Red; font-weight: bold; font-size: 13px;">
                Error:
                <% Response.Write(Request.Form.Get("reasonCode")); %><br />
                <% if (Request.Form.Get("reasonCode") == "102")
                   { %>
                Some of the required fields are missing. Please provide all mandatory fields and
                ...
                <%}
                   ...
                   { %>
                Unable to connect to issuer. Your card is not charged. Please try again after some
                time or try with a different card
                <%}
                   ...
                   { %>
                The card is either not activated or cannot be used online. Please try again with
                a different card
                <%}
                ...
                <%}
                   ...
                   { %>
                The card verification number is invalid. Please provide correct verification number
                ...
                <%}
                   ...
                   { %>
                Some error occurred processing the card. Please try again or try with a different
                card
                <%}
                ...
                <%}
                   ...
                   { %>
                Invalid card type. Please provide select correct card type to proceed with checkout
                or contact support
                <%}
                   ...
                   { %>
                Some error occurred while processing the payment. Your card is not charged. Please
                try again after some time or contact support
                <%}
                ...
                <%}
                   ...
                   { %>
                Invalid card type selected for the given card number. Please select correct card
                type to proceed with checkout
                <%}
                   else if (Request.Form.Get("reasonCode") == "476")//The customer cannot be authenticated. Possible action: Review the customer's order.
                   { %>
                Unable to authenticate the card. Please try again with a different card or contact
                support
                <%}
                ...
                <%}
                   ...
                   { %>
                Some error occurred while processing the payment. Your card is not charged. Please
                wait for few minutes and try again with checkout
                <%}
                   ...
                   { %>
                Some error occurred while processing the payment. Your card might have been charged.
                To avoid duplicating the payment, please contact support
                <%}
