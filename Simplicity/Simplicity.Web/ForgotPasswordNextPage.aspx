<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Main.Master" AutoEventWireup="true"
    CodeBehind="ForgotPasswordNextPage.aspx.cs" Inherits="Simplicity.Web.ForgotPasswordNextPage" %>
    ...
    <div class="logindiv">
        ...
        <div style="padding-left: 30px;">
            ...
            <div class="floatLeft">
                ...
                <div class="floatLeft" style="width:60%">
                    <asp:TextBox ID="listForgotPasswordQuestionText" CssClass="forgetfield" runat="server" ReadOnly="true"></asp:TextBox>
                </div>
            </div>
            <div>
                <div class="floatLeft" style="width:60%">
