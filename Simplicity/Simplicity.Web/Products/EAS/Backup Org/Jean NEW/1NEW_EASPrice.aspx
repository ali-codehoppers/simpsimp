<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Products.master" AutoEventWireup="true" CodeBehind="OnlinePrice.aspx.cs" Inherits="Simplicity.Web.Products.Onlinr.OnlinePrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftNavPlaceHolder" runat="server">
    <div class="leftNavBarOnline">
        <div>
            <a href="../../WatchDemo.aspx?product_id=1" id="watch_Online"></a>
        </div>
        <div>
            <a href="OnlinePrice.aspx?productid=1" id="buy_Online"></a>
        </div>
        <div>
            <a href="OnlinePrice.aspx?productid=1&try=try" id="try_Online"></a>
        </div>
        <div>
            <a href="../../CallMeBack.aspx" id="call_online"></a>
    ...
    <div id="secnavbar" class="floatLeft">
        ...
        <div id="nsecnavbar">
            ...
            <div id="priceicon" class="floatRight">
                <asp:HyperLink ID="HyperLink1" NavigateUrl="~/Products/Online/OnlinePrice.aspx?productid=1" CssClass="icon_link" runat="server">
            ...
            <div id="homeicon" class="floatRight">
                <a href="javascript:populateContents('Details.aspx','contentsDiv')" class="icon_link">
                    <asp:Image ID="Image1" ImageUrl="~/Images/icon_home_Online.jpg" Width="38" Height="30"
                        runat="server" /><br />
                    Home </a>
            </div>
            <div>
