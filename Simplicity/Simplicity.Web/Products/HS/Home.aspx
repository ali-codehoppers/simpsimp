<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Products.master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Simplicity.Web.Products.HS.Home" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" runat="server">
    <link href='<%=Page.ResolveClientUrl("~/Styles/products.css")%>' rel="stylesheet" type="text/css" />
</asp:Content>
            ...
            <div id="secnavbar" class="floatLeft">
                ...
                <div id="nsecnavbar">
                    <div id="homeicon" class="floatLeft">                        
                        ...
                        <asp:Image ID="Image1" ImageUrl="~/Images/icon_home_hns.jpg" width="38" height="30" runat="server"/><br />Home</a>
                    </div>
