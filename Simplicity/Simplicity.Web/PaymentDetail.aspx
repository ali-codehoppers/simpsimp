<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Main.Master" AutoEventWireup="true" CodeBehind="PaymentDetail.aspx.cs" Inherits="Simplicity.Web.PaymentDetail" %>
    ...
    <div id="PaymentAddresssubdirectory" class="PaymentAddressbottom_border">
        <div>
            <a class="login" href="#">Trolley </a>&gt;&gt; <a class="login" href="#">Billing &amp;
                Shipping Information </a>&gt;&gt; <a class="login" href="#">Confirm
                    Checkout </a>&gt;&gt; <a class="PaymentAddresscurrent" href="#">Payment Details </a>
        </div>
    </div>
    <div id="heading1">
        <h2>
    ...
    <div>
		...
		<div id="paymentDetails">
			...
			<div class="row">
				...
				<div class="col2"><asp:TextBox ID="txtCardNumber" MaxLength="16"  CssClass="login_field_big" runat="server"></asp:TextBox>
				...
				<div class="col2">
				    <asp:DropDownList id="txtStartMonth" runat="server" CssClass="login_field_small" style="Width:40px">
				    ...
				    &nbsp;&nbsp;<asp:DropDownList id="txtStartYear" runat="server" CssClass="login_field_small" style="Width:60px"></asp:DropDownList>		
				    
				</div>
			</div>
            <div class="row">
				<div class="col1">Expiry Date</div>
				<div class="col2">
				    <asp:DropDownList id="txtExpiryMonth" runat="server" CssClass="login_field_small" style="Width:40px">
				        <asp:ListItem Value="01">01</asp:ListItem>
				        <asp:ListItem Value="02">02</asp:ListItem>
				        <asp:ListItem Value="03">03</asp:ListItem>
				        <asp:ListItem Value="04">04</asp:ListItem>
				    ...
				    &nbsp;&nbsp;<asp:DropDownList id="txtExpiryYear" runat="server" CssClass="login_field_small" style="Width:60px"></asp:DropDownList>
				</div>
			</div>
			<div class="row">
			...
			<div class="row" style="padding-top:15px;">
				<div><h2>Card Billing Address</h2></div>
			</div>
